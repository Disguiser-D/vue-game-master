    ...
    <h1>这是一个高仿的页面</h1>
		...
		<div class="addrsnum">
			<ul class="work">
				...
				<li>|</li>
				<li><a href="#">沪ICP备: 沪B2－20080012</a></li>
			</ul>
		</div>
		<div class="clearall"></div>
		<div class="report">
			<ul>
				<li><p>互联网违法和不良信息举报电话：0571-28090163</p></li>
				<li><p>沪公网安备：31011502002167</p></li>
				<li><p>网上有害信息专区</p></li>
			</ul>
		</div>
		<div class="addr">
		...
		<div class="addr">
			<ul>
				<li><p>上海市张江高科技园区碧波路690号5号楼301-A</p></li>
				<li>|</li>
